...
plot(hclust(dist(t(as.matrix(A.H.i_ancestral_movement)[,1:(length(useful.species)+1)+1]))), main = "",sub = "", xlab = "High MIR/L2 region")

plot(hclust(dist(t(as.matrix(A.L.i_ancestral_movement)[,1:(length(useful.species)+1)+1]))),  main = "",sub = "", xlab = "Low MIR/L2 region")

plot(hclust(dist(t(as.matrix(R.S.1_ancestral_movement)[,1:(length(useful.species)+1)+1]))),  main = "",sub = "", xlab = "Random sample region")
...
plot(hclust(dist(t(as.matrix(A.H.u_ancestral_movement)[,1:(length(useful.species)+1)+1]))))
plot(hclust(dist(t(as.matrix(A.L.u_ancestral_movement)[,1:(length(useful.species)+1)+1]))))
plot(hclust(dist(t(as.matrix(R.S.2_ancestral_movement)[,1:(length(useful.species)+1)+1]))))
plot(hclust(dist(t(as.matrix(R.S.3_ancestral_movement)[,1:(length(useful.species)+1)+1]))))
plot(hclust(dist(t(as.matrix(R.S.4_ancestral_movement)[,1:(length(useful.species)+1)+1]))))
...
for(s in c(useful.species,spec1)){
	...
	Dist <- as.matrix(daisy(spec, stand = TRUE))
...
plot(hclust(dist(t(as.matrix(A.H.i_unknown_movement)[,1:(length(useful.species)+1)+1]))))
plot(hclust(dist(t(as.matrix(A.H.u_unknown_movement)[,1:(length(useful.species)+1)+1]))))
plot(hclust(dist(t(as.matrix(A.L.i_unknown_movement)[,1:(length(useful.species)+1)+1]))))
plot(hclust(dist(t(as.matrix(A.L.u_unknown_movement)[,1:(length(useful.species)+1)+1]))))
plot(hclust(dist(t(as.matrix(R.S.1_unknown_movement)[,1:(length(useful.species)+1)+1]))))
plot(hclust(dist(t(as.matrix(R.S.2_unknown_movement)[,1:(length(useful.species)+1)+1]))))
plot(hclust(dist(t(as.matrix(R.S.3_unknown_movement)[,1:(length(useful.species)+1)+1]))))
plot(hclust(dist(t(as.matrix(R.S.4_unknown_movement)[,1:(length(useful.species)+1)+1]))))
...
plot(hclust(A.H.i_distance), main = "",sub = "", xlab = "High MIR/L2 region")
plot(hclust(A.L.i_distance), main = "",sub = "", xlab = "Low MIR/L2 region")
plot(hclust(R.S.1_distance), main = "",sub = "", xlab = "Random sample region")
dev.off()


plot(hclust(A.H.u_distance))
plot(hclust(A.L.u_distance))
plot(hclust(R.S.2_distance))
plot(hclust(R.S.3_distance))
plot(hclust(R.S.4_distance))
...
for(s in useful.species){
	...
	thing <- data.frame(ancestral = c(A.H.i_ancestral_movement[,s], A.L.i_ancestral_movement[,s],
		 R.S.1_ancestral_movement[,s]), 
	     edge_length = c(A.H.i_unknown_movement[,s], A.L.i_unknown_movement[,s],
		 R.S.1_unknown_movement[,s]),
		 region = c(rep("High MIR/L2",length(A.H.i)), rep("Low MIR/L2", length(A.L.i)),
		 rep("Random sample",length(R.S.1)))
		 )
